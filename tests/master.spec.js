...
test('Login Functionality', async ({ page }) => {
  ...
  await page.getByLabel('Master Account').click();
  await page.getByLabel('Trustees *').click();
  await page.getByLabel('Alltrust SIPP Limited', { exact: true }).click();
  ...
  const Lstname = faker.person.firstName();
    ...
    await page.getByLabel('Passport/ID Card No *').fill('ZT3482');
    ...
    await page.getByLabel('Mobile Number *').fill('875484457');
 ...
 // await page.getByLabel('Account Name').click();
  ...
  await page.getByLabel('isClientAllowedToSell').click();
   await page.getByLabel('isConsultantAllowedToPurchase').click();
    await page.getByLabel('isConsultantAllowedToSell').click();
  ...
  await page.locator('input[name="fees\\.' + 0 +'\\.value"]').fill('3');
