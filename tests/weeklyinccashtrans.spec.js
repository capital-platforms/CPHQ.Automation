...
test('Cash Possition', async ({ page }) => {
      ...
      await menus.MovReportloginmenu( 'Reports', 'Weekly Reports' , 'Weekly Incoming Cash Transfer');
 
await page.getByRole('textbox', { name: 'Name: (Optional)' }).fill('WICT by Automation testing')
