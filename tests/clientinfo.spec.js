...
test('Client Info', async ({ page }) => {
      ...
      const menus = new Menus(page);
       await menus.MovReportloginmenu( 'Reports', 'Moventum Reports' , 'Client Info');

await page.getByRole('textbox', { name: 'Name: (Optional)' }).fill('Client Report by Automation testing')
