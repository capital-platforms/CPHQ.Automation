...
test('Cash Possition', async ({ page }) => {
      ...
      await menus.MovReportloginmenu( 'Reports', 'Moventum Reports' , 'Cash Position');
 
await page.getByRole('textbox', { name: 'Name: (Optional)' }).fill('Cash Position Report by Automation testing')
