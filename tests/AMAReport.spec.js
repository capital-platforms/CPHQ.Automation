...
test('Cash Possition', async ({ page }) => {
      ...
      await menus.MovReportloginmenu( 'Reports', 'Weekly Reports' , 'Available Cash (AMA)');
 
await page.getByRole('textbox', { name: 'Name: (Optional)' }).fill('AMA by Automation testing')
