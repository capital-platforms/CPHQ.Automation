...
test('Cash Possition', async ({ page }) => {
      ...
      await menus.MovReportloginmenu( 'Reports', 'Weekly Reports' , 'Cash Disbursement');
 
await page.getByRole('textbox', { name: 'Name: (Optional)' }).fill('Cash Disbursement by Automation testing')
