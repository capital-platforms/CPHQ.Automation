...
export class Account {
 ...
 this.P1 = process.env.P1;
    ...
    this.P3 = process.env.P3;
            ...
            this.whitelabel = page.getByLabel('White Label *');//page.getByRole('combobox', { name: 'White Label *' });
...
async subsidary()
{
 ...
 // await this.page.getByLabel('Main Subsidiary').getByText('Main Subsidiary').click();
 await this.page.locator('[role="option"]').first().click();
 await this.savesubsidary.click();
...
const FCity = faker.location.city()
  ...
  await this.savedisburment.click();
}
