...
export class DFMAccount {
        constructor(page) {
          ...
          const { P1, P2, P3 } = process.env;
            ...
            this.StandaloneorLink = page.getByRole('combobox', { name: 'StandAlone or Linked *' });
...
//PERSONAL DETAILS
            ...
            this.schemename =page.getByRole('textbox', { name: 'Scheme Name *' });
            this.membername= page.getByRole('textbox', { name: 'Member Name *' });
...
//Account type tab
     ...
     // await this.page.locator('[role="option"]').first().click();
     await this.page.locator('[role="option"]', { hasText: 'DFM Account' }).click();

     await this.DFMProvider.click();
       await this.page.locator('[role="option"]').first().click();
              

await this.StandaloneorLink.click();
       await this.page.locator('[role="option"]').first().click();
...
async personaldetails()  {
    ...
    const title = titles[randomtitle];
        ...
        await this.schemename.fill(Ffrstname);
        await this.membername.fill(Lstname);
