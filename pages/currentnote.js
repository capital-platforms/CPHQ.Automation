...
if ( Notetype == 1)
{
await  this.page.getByRole('gridcell', { name: '22' }).first().click({ force: true });
}
else{
    await  this.page.getByRole('gridcell', { name: '23' }).first().click({ force: true });
}
...
await  this.page.getByRole('gridcell', { name: '20' }).click();
    ...
    await  this.page.getByRole('gridcell', { name: '22' }).click();
}
